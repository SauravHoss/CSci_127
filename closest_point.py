...
def getColumnNames():
     ...
     """
     latName, lonName = input("Enter column name for latitude: "), input("Enter column name for longitudeL ")
...
def getLocale():
     ...
     lat, lon = float(input("Enter current lattitude: ")), float(input("Enter current longitude: "))      #<-- placeholder, can remove once defined.
